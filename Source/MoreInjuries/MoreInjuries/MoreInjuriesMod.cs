...
public class MoreInjuriesMod : Mod
{
    ...
    public override void DoSettingsWindowContents(Rect canvas)
    {
        ...
        list.CheckboxLabeled($"Enable logging (default: {ENABLE_LOGGING_DEFAULT})", ref Settings.EnableLogging);
        list.CheckboxLabeled($"Enable verbose logging (default: {ENABLE_VERBOSE_LOGGING_DEFAULT})", ref Settings.EnableVerboseLogging);
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable bone fractures (default: {ENABLE_FRACTURES_DEFAULT})", ref Settings.EnableFractures,
            """
            ...
            """);
        list.Label($"Minimum damage threshold for fractures: {Settings.FractureDamageTreshold} (default: {FRACTURE_DAMAGE_TRESHOLD_DEFAULT})", -1,
            """
        ...
        list.Label($"Chance of bone fractures on damage: {Settings.FractureChanceOnDamage} (default: {FRACTURE_CHANCE_ON_DAMAGE_DEFAULT})", -1,
            """
        ...
        list.CheckboxLabeled($"Enable bone fragment lacerations (default: {ENABLE_BONE_FRAGMENT_LACERATIONS_DEFAULT})", ref Settings.EnableBoneFragmentLacerations,
            """
            ...
            """);
        list.Label($"Change of bone fragment lacerations: {Settings.SplinteringFractureChance} (default: {SPLINTERING_FRACTURE_CHANCE_DEFAULT})", -1,
            """
        ...
        list.Label($"Chance of bone fragment lacerations per body part: {Settings.BoneFragmentLacerationChancePerBodyPart} (default: {BONE_FRAGMENT_LACERATION_CHANCE_PER_BODY_PART_DEFAULT})", -1,
            """
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable choking on blood mechanics (default: {ENABLE_CHOKING_DEFAULT})", ref Settings.EnableChoking,
            """
            ...
            """);
        list.CheckboxLabeled($"Enable choking sounds (default: {ENABLE_CHOKING_SOUNDS_DEFAULT})", ref Settings.EnableChokingSounds,
            """
            ...
            """);
        list.Label($"Minimum bleed rate for choking: {Settings.ChokingMinimumBleedRate} (default: {CHOKING_MINIMUM_BLEED_RATE_DEFAULT})", -1,
            """
        ...
        list.Label($"Chance of choking on blood after severe damage: {Settings.ChokingChanceOnDamage} (default: {CHOKING_CHANCE_ON_DAMAGE_DEFAULT})", -1,
            """
        ...
        list.Label($"Minimum suction device success rate for unskilled users: {Settings.SuctionDeviceMinimumSuccessRate} (default: {SUCTION_DEVICE_MINIMUM_SUCCESS_RATE_DEFAULT})", -1,
            """
        ...
        list.CheckboxLabeled($"Enable inhalation injuries (default: {ENABLE_FIRE_INHALATION_DEFAULT})", ref Settings.EnableFireInhalation,
            """
            ...
            """);
        list.CheckboxLabeled($"Enable lung collapses (default: {ENABLE_LUNG_COLLAPSE_DEFAULT})", ref Settings.EnableLungCollapse,
            """
            ...
            """);
        list.Label($"Chance of lung collapse on thermobaric damage: {Settings.LungCollapseChanceOnDamage} (default: {LUNG_COLLAPSE_CHANCE_ON_DAMAGE_DEFAULT})", -1,
            """
        ...
        list.Label($"Square root of the maximum initial severity of lung collapse: {Settings.LungCollapseMaxSeverityRoot} (default: {LUNG_COLLAPSE_MAX_SEVERITY_ROOT_DEFAULT})", -1,
        ...
        list.Label("Spalling");
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable spalling mechanics (default: {ENABLE_SPALLING_DEFAULT})", ref Settings.EnableSpalling,
        ...
        list.Label(
            $"""
            Base chance of armor creating spall based on condition: {Settings.ArmorHealthSpallingThreshold} (default: {ARMOR_HEALTH_SPALLING_THRESHOLD_DEFAULT})
        ...
        list.Label($"Chance of spalling injuries: {Settings.SpallingChance} (default: {SPALLING_CHANCE_DEFAULT})", -1,
            """
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable hypovolemic shock mechanics (default: {ENABLE_HYPOVOLEMIC_SHOCK_DEFAULT})", ref Settings.EnableHypovolemicShock,
            ...
            """);
        list.Label($"Chance of hypovolemic shock to cause organ hypoxia (every 300 ticks/5s): {Settings.OrganHypoxiaChance} (default: {ORGAN_HYPOXIA_CHANCE_DEFAULT})", -1,
            """
        ...
        list.Label($"Reduction factor for organ hypoxia chance when patient is tended: {Settings.OrganHypoxiaChanceReductionFactor} (default: {ORGAN_HYPOXIA_CHANCE_REDUCTION_FACTOR_DEFAULT})", -1,
        ...
        list.CheckboxLabeled($"Enable cardiac arrest on high blood loss (default: {ENABLE_CARDIAC_ARREST_ON_HIGH_BLOOD_LOSS_DEFAULT})", ref Settings.EnableCardiacArrestOnHighBloodLoss,
            ...
            """);
        list.Label($"Chance of cardiac arrest on high blood loss: {Settings.CardiacArrestChanceOnHighBloodLoss} (default: {CARDIAC_ARREST_CHANCE_ON_HIGH_BLOOD_LOSS_DEFAULT})", -1,
            """
        ...
        list.Label($"Minimum defibrillator success rate for unskilled user: {Settings.DefibrillatorMinimumSuccessRate} (default: {DEFIBRILLATOR_MINIMUM_SUCCESS_RATE_DEFAULT})", -1,
            """
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable concussion mechanics (default: {ENABLE_CONCUSSION_DEFAULT})", ref Settings.EnableConcussion,
            """
            ...
            """);
        list.Label($"Raw head trauma threshold for guaranteed concussion: {Settings.ConcussionThreshold} (default: {CONCUSSION_THRESHOLD_DEFAULT})", -1,
        ...
        list.Label($"Chance of concussion after severe head injuries: {Settings.ConcussionChance} (default: {CONCUSSION_CHANCE_DEFAULT})", -1,
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable hemorrhagic stroke mechanics (default: {ENABLE_HEMORRHAGIC_STROKE_DEFAULT})", ref Settings.EnableHemorrhagicStroke,
            """
            ...
            """);
        list.Label($"Raw head trauma threshold for guaranteed hemorrhagic stroke: {Settings.HemorrhagicStrokeThreshold} (default: {HEMORRHAGIC_STROKE_THRESHOLD_DEFAULT})", -1,
        ...
        list.Label($"Chance of hemorrhagic stroke after severe head injuries: {Settings.HemorrhagicStrokeChance} (default: {HEMORRHAGIC_STROKE_CHANCE_DEFAULT})", -1,
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable EMP damage to bionics (default: {ENABLE_EMP_DAMAGE_TO_BIONICS_DEFAULT})", ref Settings.EnableEmpDamageToBionics,
            """
            ...
            """);
        list.Label($"Chance of EMP damage to bionics: {Settings.EmpDamageToBionicsChance} (default: {EMP_DAMAGE_TO_BIONICS_CHANCE_DEFAULT})", -1,
            """
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable adrenaline mechanics (default: {ENABLE_ADRENALINE_DEFAULT})", ref Settings.EnableAdrenaline,
            """
            ...
            """);
        list.Label($"Chance of adrenaline rush on damage: {Settings.AdrenalineChanceOnDamage} (default: {ADRENALINE_CHANCE_ON_DAMAGE_DEFAULT})", -1,
        ...
        list.Label($"Damage threshold for certain adrenaline rush: {Settings.CertainAdrenalineThreshold} (default: {CERTAIN_ADRENALINE_THRESHOLD_DEFAULT})", -1,
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable hydrostatic shock mechanics (default: {ENABLE_HYDROSTATIC_SHOCK_DEFAULT})", ref Settings.EnableHydrostaticShock,
        ...
        list.Label($"Chance of hydrostatic shock on damage: {Settings.HydrostaticShockChanceOnDamage} (default: {HYDROSTATIC_SHOCK_CHANCE_ON_DAMAGE_DEFAULT})", -1,
            """
        ...
        Text.Font = GameFont.Small;
        list.CheckboxLabeled($"Enable hearing damage mechanics (default: {ENABLE_BASIC_HEARING_DAMAGE_DEFAULT})", ref Settings.EnableBasicHearingDamage,
            """
        ...
        list.CheckboxLabeled($"Enable advanced hearing damage simulation (default: {ENABLE_ADVANCED_HEARING_DAMAGE_DEFAULT})", ref advancedHearingDamage,
            """
        ...
        list.Label($"Chance of intestinal spilling on damage: {Settings.IntestinalSpillingChanceOnDamage} (default: {INTESTINAL_SPILLING_CHANCE_ON_DAMAGE_DEFAULT})", -1,
            """
