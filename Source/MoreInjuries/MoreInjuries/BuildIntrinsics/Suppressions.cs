...
internal static class Suppressions
{
    ...
    public const string JUSTIFY_IDE0032_XML_DEF_REQUIRES_FIELD = "Cannot encapsulate replace XML-bound fields with properties, required for reflection. Name must match XML def name.";
